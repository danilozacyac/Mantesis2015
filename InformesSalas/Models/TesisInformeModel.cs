...
namespace InformesSalas.Models
{
    public class TesisInformeModel
    {
        ...
        //public List<TesisInforme> GetTesisSalasVolumen(int sala)
        //{
        //    List<TesisInforme> listaTesis = new List<TesisInforme>();
        ...
        {
            OleDbConnection connection = new OleDbConnection(ConfigurationManager.ConnectionStrings["salasDic"].ConnectionString);
            OleDbCommand cmd;
        ...
        public List<TesisInforme> GetTesisSinCalsificarImpresion()
        {
            ...
            try
            {
                ...
                string sqlCadena = "SELECT ius,rubro,texto,prec,tesis,pagina,epoca,[ta_tj],fuente,volumen FROM Tesis WHERE " + ClasifVar.CurrentProject.CondicionProyecto;//  ORDER By";
                ...
                while (dataReader.Read())
                {
                    ...
                    tesis.Epoca = dataReader["epoca"].ToString();
                    tesis.TaTj = Convert.ToInt16(dataReader["TA_TJ"]);
                    tesis.Fuente = Convert.ToInt32(dataReader["Fuente"]);
                    tesis.NumericOrder = this.GetNumeroDeTesisOrden(tesis.Tesis, tesis.TaTj);
                    tesis.Volumen = dataReader["volumen"].ToString();
